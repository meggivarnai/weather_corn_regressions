...
A:Looking at our p-value (1.767 e-13), there is evidence of a significant time trend. The estimated slope is an increase of 2.457 yield per year, and our adjusted R-squared value shows us that abbout 75% of the data fit this model. 
...
A: square of explanitory variable. use if linear doesnt fit well. There is no evidence of a slowing yield growth. 
